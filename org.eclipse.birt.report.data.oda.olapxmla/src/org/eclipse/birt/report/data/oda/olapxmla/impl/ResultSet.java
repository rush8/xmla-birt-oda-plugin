...
public class ResultSet implements IResultSet
{
    ...
    public ResultSet(Matrix pDataMatrix)
    {
	...
	public boolean next() throws OdaException
	{
        ...
        while(m_currentRowId < dataMatrix.getHeight()-1) {
        	m_currentRowId++;
        	return true;
        }      
	...
	{
		if (dataMatrix.get(index-1,getRow()).isSameAsPrev()) return "";
		
        return (dataMatrix.get(index-1,getRow())).getValue();
	}
	...
	public double getDouble( int index ) throws OdaException
	{
		try
		{
			return new Double((dataMatrix.get(index-1,getRow())).getValue());
		}
