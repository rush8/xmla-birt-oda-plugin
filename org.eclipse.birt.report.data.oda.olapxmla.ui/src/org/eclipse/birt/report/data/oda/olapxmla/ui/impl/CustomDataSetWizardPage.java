...
package org.eclipse.birt.report.data.oda.olapxmla.ui.impl;
...
public class CustomDataSetWizardPage extends DataSetWizardPage
{
    ...
    private static String DEFAULT_MESSAGE = "Define the MDX query text for the data set";
	...
	private void savePage( DataSetDesign dataSetDesign )
	{
        ...
        try
        {
             ...
             */
            IDriver customDriver = new org.eclipse.birt.report.data.oda.olapxmla.impl.OlapXmlaDriver();
